...
- Browser cookie reading: [`BrowserCookies.swift`](../../Sources/Pulse/BrowserCookies.swift) and [authentication.md](authentication.md). Qoder uses the same path for a different host.
