...
| | | 读取方式 | 注意 |
|:---:|---|---|---|
| <picture><source media="(prefers-color-scheme: dark)" srcset="Docs/icons/claude.svg"><img src="Sources/Pulse/Resources/claude.svg" width="30" alt=""></picture> | **Claude Code** | 账号的用量接口，用 Claude Code 已保存的登录信息；失败时回退到状态栏 | — |
